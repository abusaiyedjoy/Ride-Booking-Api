...
passport_1.default.use(new passport_local_1.Strategy({
    ...
    try {
        ...
        const isGoogleAuthenticated = isUserExist.auth.some((obj) => obj.provider === "google");
        if (isGoogleAuthenticated && !isUserExist.password) {
            return done("You have already set you password. Now you can change the password from your profile password update", false);
        }
