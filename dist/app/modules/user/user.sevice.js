...
const createUser = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashedPassword = yield bcryptjs_1.default.hash(password, env_1.envVars.BCRYPT_SALT_ROUNDS);
    const authProvider = [
        {
...
const updateUser = (userId, payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (payload.password) {
        payload.password = yield bcryptjs_1.default.hash(payload.password, env_1.envVars.BCRYPT_SALT_ROUNDS);
    }
