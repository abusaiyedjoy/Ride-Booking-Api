...
router.post("/login", auth_controller_1.AuthController.crediantialsLogin);
...
router.get("/google/callback", passport_1.default.authenticate("google", { failureRedirect: `${env_1.envVars.FRONTEND_URL}/login?error=There is an error` }), auth_controller_1.AuthController.googleCallbackController);
